> **⚠️ این سند مربوط به baseline تاریخی ۱۰ اوت ۲۰۲۶ است.**
> برای وضعیت فعلی به architecture-doc.md مراجعه کنید.
> خلاصه: core.js از 5,889 به 1,904 کاهش یافت، edCur از 621 به 0 رسید، تست‌ها از 39 به 244 افزایش یافت.
