...
(function attachCoreSettingsService(globalScope) {
  ...
  function create({
    ...
    toggleMetronome = (...args) => globalScope.toggleMetronome?.(...args),
    stopMetronome = (...args) => globalScope.stopMetronome?.(...args),
    startMetronome = (...args) => globalScope.startMetronome?.(...args),
    updateReturnToStartButton = () =>
      globalScope.updateReturnToStartButton?.(),
    getSizeLocked = () => false,
    toggleSizeLock = () => {},
    toast = () => {},
    logger = console
