      ...
      documentRef.head.innerHTML = `
        <style>
          ...
          * { box-sizing: border-box; margin: 0; padding: 0; }
          ...
          .popup-sync-line { position: relative; margin-top: 1.8em; padding: 4px 12px; border-bottom: none !important; transition: opacity 0.2s ease, color 0.2s ease, background 0.2s ease, text-shadow 0.2s ease; }
          .popup-sync-line.active { color: #fff; border-radius: 8px; z-index: 10; }
          .popup-sync-line.done { opacity: 0.50; }
