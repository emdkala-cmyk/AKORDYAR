...
assert.doesNotMatch(editor, /TimelineScrollbarsService/);
assert.doesNotMatch(editor, /TimelinePanelLayoutService/);
assert.match(corePanelLayout, /TimelineScrollbarsService/);
assert.match(corePanelLayout, /TimelinePanelLayoutService/);
