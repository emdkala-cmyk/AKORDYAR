...
const resultText = elements.get('archiveResultCount').textContent;
assert.ok(resultText === '2 نتیجه' || resultText === '2 results', `Expected '2 نتیجه' or '2 results', got '${resultText}'`);
...
const statusText = elements.get('archiveStatusText').textContent;
assert.ok(statusText === 'سطل زباله' || statusText === 'trash', `Expected 'سطل زباله' or 'trash', got '${statusText}'`);
