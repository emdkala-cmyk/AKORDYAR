...
assert.match(editor, /const editorCopySelected =/);
assert.match(editor, /const editorCutSelected =/);
assert.match(editor, /const editorPasteClipboard =/);
assert.match(editor, /copySelected:\s*\(\) => editorCopySelected\(\)/);
assert.match(editor, /cutSelected:\s*\(\) => editorCutSelected\(\)/);
assert.match(editor, /pasteClipboard:\s*\(\) => editorPasteClipboard\(\)/);
assert.doesNotMatch(editor, /^\s*copySelected,\s*$/m);
